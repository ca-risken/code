...
type Gitleaks struct {
	...
	CodeDataSourceId    string `protobuf:"bytes,2,opt,name=code_data_source_id,json=codeDataSourceId,proto3" json:"code_data_source_id,omitempty"`
	ProjectId           uint32 `protobuf:"varint,3,opt,name=project_id,json=projectId,proto3" json:"project_id,omitempty"`
	Type                Type   `protobuf:"varint,4,opt,name=type,proto3,enum=code.code.Type" json:"type,omitempty"`
	...
	RepositoryPattern   string `protobuf:"bytes,6,opt,name=repository_pattern,json=repositoryPattern,proto3" json:"repository_pattern,omitempty"`
	GithubUser          string `protobuf:"bytes,7,opt,name=github_user,json=githubUser,proto3" json:"github_user,omitempty"`
	PersonalAccessToken string `protobuf:"bytes,8,opt,name=personal_access_token,json=personalAccessToken,proto3" json:"personal_access_token,omitempty"`
	GitleaksConfig      string `protobuf:"bytes,9,opt,name=gitleaks_config,json=gitleaksConfig,proto3" json:"gitleaks_config,omitempty"`
	Status              Status `protobuf:"varint,10,opt,name=status,proto3,enum=code.code.Status" json:"status,omitempty"`
	StatusDetail        string `protobuf:"bytes,11,opt,name=status_detail,json=statusDetail,proto3" json:"status_detail,omitempty"`
	ScanAt              int64  `protobuf:"varint,12,opt,name=scan_at,json=scanAt,proto3" json:"scan_at,omitempty"`
...
func (x *Gitleaks) GetCodeDataSourceId() string {
	if x != nil {
		return x.CodeDataSourceId
	}
	return ""
...
type GitleaksForUpsert struct {
	...
	Name                string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // Unique key for Gitleaks entity.
	ProjectId           uint32 `protobuf:"varint,2,opt,name=project_id,json=projectId,proto3" json:"project_id,omitempty"`
	Type                Type   `protobuf:"varint,3,opt,name=type,proto3,enum=code.code.Type" json:"type,omitempty"`
	...
	RepositoryPattern   string `protobuf:"bytes,5,opt,name=repository_pattern,json=repositoryPattern,proto3" json:"repository_pattern,omitempty"`
	GithubUser          string `protobuf:"bytes,6,opt,name=github_user,json=githubUser,proto3" json:"github_user,omitempty"`
	PersonalAccessToken string `protobuf:"bytes,7,opt,name=personal_access_token,json=personalAccessToken,proto3" json:"personal_access_token,omitempty"`
	GitleaksConfig      string `protobuf:"bytes,8,opt,name=gitleaks_config,json=gitleaksConfig,proto3" json:"gitleaks_config,omitempty"`
	Status              Status `protobuf:"varint,9,opt,name=status,proto3,enum=code.code.Status" json:"status,omitempty"`
...
var file_code_entity_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0x9b, 0x04, 0x0a, 0x08, 0x47, 0x69, 0x74, 0x6c, 0x65, 0x61, 0x6b, 0x73, 0x12, 0x1f,
	...
	,
	...
	0x5f, 0x61, 0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x73, 0x63, 0x61, 0x6e, 0x41,
	...
	0xaa, 0x03, 0x0a, 0x11, 0x47, 0x69, 0x74, 0x6c, 0x65, 0x61, 0x6b, 0x73, 0x46, 0x6f, 0x72, 0x55,
	0x70, 0x73, 0x65, 0x72, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20,
	...
	0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x12, 0x23, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0f, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x2e, 0x63, 0x6f,
	0x64, 0x65, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x27, 0x0a,
	0x0f, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x52, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x2d, 0x0a, 0x12, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x69,
	0x74, 0x6f, 0x72, 0x79, 0x5f, 0x70, 0x61, 0x74, 0x74, 0x65, 0x72, 0x6e, 0x18, 0x05, 0x20, 0x01,
	...
	0x75, 0x73, 0x65, 0x72, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x67, 0x69, 0x74, 0x68,
	...
	0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13, 0x70, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x61, 0x6c, 0x41,
	0x63, 0x63, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x27, 0x0a, 0x0f, 0x67, 0x69,
	0x74, 0x6c, 0x65, 0x61, 0x6b, 0x73, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x08, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x0e, 0x67, 0x69, 0x74, 0x6c, 0x65, 0x61, 0x6b, 0x73, 0x43, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x12, 0x29, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x09, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x2e,
	...
	,
	...
	0x02, 0x12, 0x12, 0x0a, 0x0e, 0x4e, 0x4f, 0x54, 0x5f, 0x43, 0x4f, 0x4e, 0x46, 0x49, 0x47, 0x55,
	0x52, 0x45, 0x44, 0x10, 0x03, 0x12, 0x09, 0x0a, 0x05, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x04,
	0x42, 0x2e, 0x5a, 0x2c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x43,
	0x79, 0x62, 0x65, 0x72, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x2f, 0x6d, 0x69, 0x6d, 0x6f, 0x73, 0x61,
	0x2d, 0x63, 0x6f, 0x64, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x63, 0x6f, 0x64, 0x65,
...
var file_code_entity_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
